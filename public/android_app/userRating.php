<?php
    ...
    class FavoriteRecipe{
        ...
        public function editFavoriteRecipe($id_android_users, $id_recipe, $rating){
			...
			if($id==0){
                ...
                $query = "insert into ".$this->db_table." (`id_android_users`, `id_recipe`, `opinion`, `rating`) values ('$id_android_users', '$id_recipe', '', $rating)";
				//$query = "insert into ".$this->db_table." (login, email               ) values ('$login', '$email', '$password'  )";
				//$query = "insert into ".$this->db_table." (id_android_users, id_recipe) values ('4', '10')";
				...
				$query = "update ".$this->db_table." set `rating` = $rating where id = '$id'";
	...
	$FavoriteObject = new FavoriteRecipe();
        ...
        $json_registration = $FavoriteObject->editFavoriteRecipe($id_android_users, $id_recipe, $rating);
